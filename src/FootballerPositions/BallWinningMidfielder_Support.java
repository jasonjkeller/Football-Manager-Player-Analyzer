 ...
 *
 * Class Name: FootballerPositions.BallWinningMidfielder_Support.java
 *
...
public class BallWinningMidfielder_Support
        extends Footballer
{
    private int numOfAttributes = 10;

    // constructor
    public BallWinningMidfielder_Support(int[] ratingsArray){
        setPosition("Ball Winning Midfielder");
        setRole("Support");
