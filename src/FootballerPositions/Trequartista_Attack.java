 ...
 *
 * Class Name: FootballerPositions.Trequartista_Attack.java
 *
...
public class Trequartista_Attack
        extends Footballer
{
    private int numOfAttributes = 10;

    // constructor
    public Trequartista_Attack(int[] ratingsArray){
        setPosition("Trequartista");
        setRole("Attack");
