 ...
 *
 * Class Name: FootballerPositions.BallPlayingDefender_Stopper.java
 *
...
public class BallPlayingDefender_Stopper
        extends Footballer
{
    private int numOfAttributes = 15;

    // constructor
    public BallPlayingDefender_Stopper(int[] ratingsArray){
