 ...
 *
 * Class Name: FootballerPositions.AdvancedForward_Attack.java
 *
...
public class AdvancedForward_Attack
        extends Footballer
{
    private int numOfAttributes = 10;

    // constructor
    public AdvancedForward_Attack(int[] ratingsArray){
        setPosition("Advanced Forward");
        setRole("Attack");
