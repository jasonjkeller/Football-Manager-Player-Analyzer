 ...
 *
 * Class Name: FootballerPositions.AdvancedPlaymaker_Support.java
 *
...
public class AdvancedPlaymaker_Support
        extends Footballer
{
    private int numOfAttributes = 9;

    // constructor
    public AdvancedPlaymaker_Support(int[] ratingsArray){
        setPosition("Advanced Playmaker");
        setRole("Support");
