 ...
 *
 * Class Name: FootballerPositions.AttackingMidfielder_Attack.java
 *
...
public class AttackingMidfielder_Attack
        extends Footballer
{
    private int numOfAttributes = 10;

    // constructor
    public AttackingMidfielder_Attack(int[] ratingsArray){
