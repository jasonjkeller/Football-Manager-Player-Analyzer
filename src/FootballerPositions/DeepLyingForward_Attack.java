 ...
 *
 * Class Name: FootballerPositions.DeepLyingForward_Attack.java
 *
...
public class DeepLyingForward_Attack
        extends Footballer
{
    private int numOfAttributes = 10;

    // constructor
    public DeepLyingForward_Attack(int[] ratingsArray){
        setPosition("Deep Lying Forward");
        setRole("Attack");
    ...
    public void calculateRating(int[] playerRatingsArray) {
        ...
        positionAttributesSum = (playerRatingsArray[AttributeIndex.FINISHING.getIndex()]
