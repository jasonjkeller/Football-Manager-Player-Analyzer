 ...
 *
 * Class Name: FootballerPositions.LimitedDefender_Stopper.java
 *
...
public class LimitedDefender_Stopper
        extends Footballer
{
    private int numOfAttributes = 9;

    // constructor
    public LimitedDefender_Stopper(int[] ratingsArray){
        setPosition("Limited Defender");
        setRole("Stopper");
