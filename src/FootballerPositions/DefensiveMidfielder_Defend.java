 ...
 *
 * Class Name: FootballerPositions.DefensiveMidfielder_Defend.java
 *
...
public class DefensiveMidfielder_Defend
        extends Footballer
{
    private int numOfAttributes = 10;

    // constructor
    public DefensiveMidfielder_Defend(int[] ratingsArray){
