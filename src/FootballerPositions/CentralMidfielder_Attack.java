 ...
 *
 * Class Name: FootballerPositions.CentralMidfielder_Attack.java
 *
...
public class CentralMidfielder_Attack
        extends Footballer
{
    private int numOfAttributes = 11;

    // constructor
    public CentralMidfielder_Attack(int[] ratingsArray){
        setPosition("Central Midfielder");
        setRole("Attack");
