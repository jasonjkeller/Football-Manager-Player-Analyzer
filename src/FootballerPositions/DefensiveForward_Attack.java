 ...
 *
 * Class Name: FootballerPositions.DefensiveForward_Attack.java
 *
...
public class DefensiveForward_Attack
        extends Footballer
{
    private int numOfAttributes = 10;

    // constructor
    public DefensiveForward_Attack(int[] ratingsArray){
        setPosition("Defensive Forward");
        setRole("Attack");
