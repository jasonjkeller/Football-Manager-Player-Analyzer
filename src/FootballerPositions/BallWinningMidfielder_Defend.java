 ...
 *
 * Class Name: FootballerPositions.BallWinningMidfielder_Defend.java
 *
...
public class BallWinningMidfielder_Defend
        extends Footballer
{
    private int numOfAttributes = 10;

    // constructor
    public BallWinningMidfielder_Defend(int[] ratingsArray){
