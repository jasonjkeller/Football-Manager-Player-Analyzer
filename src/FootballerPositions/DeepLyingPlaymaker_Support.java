 ...
 *
 * Class Name: FootballerPositions.DeepLyingPlaymaker_Support.java
 *
...
public class DeepLyingPlaymaker_Support
        extends Footballer
{
    private int numOfAttributes = 10;

    // constructor
    public DeepLyingPlaymaker_Support(int[] ratingsArray){
        setPosition("Deep Lying Playmaker");
        setRole("Support");
