 ...
 *
 * Class Name: FootballerPositions.DefensiveWinger_Support.java
 *
...
public class DefensiveWinger_Support
        extends Footballer
{
    private int numOfAttributes = 10;

    // constructor
    public DefensiveWinger_Support(int[] ratingsArray){
        setPosition("Defensive Winger");
        setRole("Support");
    ...
    public void calculateRating(int[] playerRatingsArray) {
        ...
        positionAttributesSum = (playerRatingsArray[AttributeIndex.CROSSING.getIndex()]
                               + playerRatingsArray[AttributeIndex.DRIBBLING.getIndex()]
