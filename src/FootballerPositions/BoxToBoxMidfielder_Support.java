 ...
 *
 * Class Name: FootballerPositions.BoxToBoxMidfielder_Support.java
 *
...
public class BoxToBoxMidfielder_Support
        extends Footballer
{
    private int numOfAttributes = 18;

    // constructor
    public BoxToBoxMidfielder_Support(int[] ratingsArray){
        setPosition("Box To Box Midfielder");
        setRole("Support");
